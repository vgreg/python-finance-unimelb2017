...
# Python 3 converts automatically to floating point if required
# Not no in Python 2, but we can activate this feature for compatibility.
...
# Exercise: fund and code the better way! (Google search allowed!)
...
# Anywhere in you code, you can raise your own exceptions
